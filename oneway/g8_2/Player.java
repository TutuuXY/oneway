...
// need to fix endpoint start condition
// need to consider whether new cars can enter
// think about the cars in the road fit into them latest parking lots
// think about once a new car enters, where is the latest parking lot and between starting point and the latest parking lots, are there empty space for the new car?
// think about the cars at the starting point parking lot shouldn't be treated as same as the the cars in the regular parking lots
